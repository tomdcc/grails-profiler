class MainFunctionalTests extends functionaltestplugin.FunctionalTestCase {
    void testSomeWebsiteFeature() {
        ...
        assertContentContains "Entering [uri: /mongo22/time] com.linkedin.grails.profiler.ProfilerHandlerInterceptor:Controller"
        assertContentContains "Exiting [uri: /mongo22/time] com.linkedin.grails.profiler.ProfilerHandlerInterceptor:Controller"
        assertContentContains "Entering [uri: /mongo22/time] DateService:currentTime"
        assertContentContains "Exiting [uri: /mongo22/time] DateService:currentTime"
    }
